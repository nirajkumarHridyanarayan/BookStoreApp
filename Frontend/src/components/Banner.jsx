      ...
      <div className="max-w-screen-2xl container my-10 mx-auto md:px-20 px-4 flex flex-col md:flex-row">
        <div className="order-2 md:order-1 w-full md:w-1/2 mt-12 md:mt-32 ">
          <div className="space-y-10">
            ...
            <p className="text-xl ">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum laudantium natus reprehenderit dignissimos! Quibusdam natus quia autem, totam mollitia exercitationem
            </p>
        ...
        <div className="order-1 w-full md:w-1/2">
          <img src={banner} className="mt-14 w-92 h-92" alt="" />
        </div>
      </div>
    </>
  )
